...
sudo wget -O /var/lib/libvirt/images/fedora31.iso 'https://download.fedoraproject.org/pub/fedora/linux/releases/31/Workstation/x86_64/iso/Fedora-Workstation-Live-x86_64-31-1.9.iso'
...
#sudo wget -O /var/lib/libvirt/images/fedora31.iso 'https://download.fedoraproject.org/pub/fedora/linux/releases/31/Server/x86_64/iso/Fedora-Server-dvd-x86_64-31-1.9.iso'
